...
// Prioritize ultra-fast Gemini 3.5 series and standard fast models for speed-sensitive workloads
...
export const planProjectExpansionEdits = async (
    ...
    const promptForAI = `
        You are a god-tier AI software architect and scale project generator.
