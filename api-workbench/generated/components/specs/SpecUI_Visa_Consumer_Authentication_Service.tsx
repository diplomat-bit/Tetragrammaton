...
export interface SpecUI_Visa_Consumer_Authentication_ServiceProps {
...
const SPEC_META = {
  ...
  version: "1",
  format: "openapi_3",
  description: "Interactive API console and live execution suite for Visa Consumer Authentication Service.",
  baseUrl: "https://sandbox.api.visa.com",
  endpoints: [{"id":"PUT__vcas_v1_confirmedMarking_clear","path":"/vcas/v1/confirmedMarking/clear","method":"PUT","summary":"Clear Confirmed marking","operationId":"put_/vcas/v1/confirmedMarking/clear","parameters":[],"hasBody":true,"samplePayload":{}},{"id":"POST__vcas_v1_confirmedMarking_mark","path":"/vcas/v1/confirmedMarking/mark","method":"POST","summary":"Confirmed marking","operationId":"post_/vcas/v1/confirmedMarking/mark","parameters":[],"hasBody":true,"samplePayload":{}},{"id":"POST__vcas_v1_confirmedMarking_markings","path":"/vcas/v1/confirmedMarking/markings","method":"POST","summary":"Get confirmed marking","operationId":"post_/vcas/v1/confirmedMarking/markings","parameters":[],"hasBody":true,"samplePayload":{"pan":"4012009508724613","IssuerID":"63ee0c5dc4844d60395c8d37","transactionId":"f37a6599-0d0a-4fbb-9dbe-aad41da883ab"}},{"id":"PUT__vcas_v1_cardStatus_upsert","path":"/vcas/v1/cardStatus/upsert","method":"PUT","summary":"Upsert Card Status","operationId":"upsertCardStatus","parameters":[],"hasBody":true,"samplePayload":{}},{"id":"POST__vcas_v1_cardStatus_lookup","path":"/vcas/v1/cardStatus/lookup","method":"POST","summary":"Look up Card Status","operationId":"lookupCardStatus","parameters":[],"hasBody":true,"samplePayload":{}}]
};

export const SpecUI_Visa_Consumer_Authentication_Service: React.FC<SpecUI_Visa_Consumer_Authentication_ServiceProps> = ({ onExecute }) => {
