...
export interface SpecUI_Account_StatementsProps {
...
const SPEC_META = {
  ...
  version: "1.0.0",
  format: "openapi_3",
  description: "Account Documents APIs Version 2.0. These APIs will be used by Citi Partners to retrieve account statements for existing Accounts from various regions . PCF Deployment Reference name --> DM-O-DocumentServices-Statements. Version 2.0.0 Added",
  baseUrl: "/api/docmgmt/acctStmt/v1",
  endpoints: [{"id":"GET__statements","path":"/statements","method":"GET","summary":"OB Returns list of account statements for a given product","operationId":"getStatementList","parameters":[{"name":"Authorization","in":"header","required":true,"type":"string","description":"The authorization token received in earlier API call. This will contain the access token and partner identity. This header is populated only for third-party partners.","example":""},{"name":"Accept","in":"header","required":true,"type":"string","description":"Content types that are acceptable for the response. Currently we support application/json","example":"application/json"},{"name":"uuid","in":"header","required":true,"type":"string","description":"128 bit random UUID generated uniquely for every request","example":"4468adf1-adfe-4f85-a2c1-f29beaa1f6ee"},{"name":"client_id","in":"header","required":true,"type":"string","description":"The client ID received during application registration in the developer portal.","example":"1c5f30d9-043c-49ff-b9c4-255a923278b2"},{"name":"countryCode","in":"header","required":false,"type":"string","description":"Two character ISO format country code.","example":""},{"name":"productFamily","in":"query","required":false,"type":"string","description":"Product Family - BANK, CREDIT_CARDS, LOANS, INVESTMENT. If not present API will return all available statements for all products.","example":""}],"hasBody":false,"samplePayload":{"referenceId":"REF-1789424098621","status":"PENDING","metadata":{"client":"API_WORKBENCH_SDK"}}},{"id":"GET__statements__statementId_","path":"/statements/{statementId}","method":"GET","summary":"OB Return the statement for the given statement ID","operationId":"getStatement","parameters":[{"name":"Authorization","in":"header","required":true,"type":"string","description":"The authorization token received in earlier API call. This will contain the access token and partner identity. This header is populated only for third-party partners.","example":""},{"name":"Accept","in":"header","required":true,"type":"string","description":"Content types that are acceptable for the response. Currently we support application/json","example":"application/json"},{"name":"uuid","in":"header","required":true,"type":"string","description":"128 bit random UUID generated uniquely for every request.","example":"4468adf1-adfe-4f85-a2c1-f29beaa1f6ee"},{"name":"client_id","in":"header","required":true,"type":"string","description":"The client ID received during customer onboarding.","example":"1c5f30d9-043c-49ff-b9c4-255a923278b2"},{"name":"countryCode","in":"header","required":false,"type":"string","description":"Two character ISO format country code.","example":""},{"name":"statementId","in":"path","required":true,"type":"string","description":"Unique id that maps to the specific statement to be downloaded.","example":""}],"hasBody":false,"samplePayload":{"referenceId":"REF-1789424098621","status":"PENDING","metadata":{"client":"API_WORKBENCH_SDK"}}}]
};

export const SpecUI_Account_Statements: React.FC<SpecUI_Account_StatementsProps> = ({ onExecute }) => {
