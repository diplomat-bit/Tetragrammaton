...
export interface SpecUI_CustodyProps {
...
const SPEC_META = {
  ...
  version: "1.0.0",
  format: "openapi_3",
  description: "Access Accounts, Holdings, Transactions, Tax lots and Failed Trades data for Institutional clients",
  baseUrl: "https://sandbox.usbank.com/wmis/custody-services/v1",
  endpoints: [{"id":"GET__accounts","path":"/accounts","method":"GET","summary":"Get the list of all accounts associated with the client/institution.","operationId":"getAccountList","parameters":[{"name":"param","in":"query","required":false,"type":"string","description":"","example":""},{"name":"param","in":"query","required":false,"type":"string","description":"","example":""},{"name":"param","in":"query","required":false,"type":"string","description":"","example":""},{"name":"param","in":"query","required":false,"type":"string","description":"","example":""},{"name":"param","in":"query","required":false,"type":"string","description":"","example":""},{"name":"accountGroupId","in":"query","required":false,"type":"string","description":"Optional accountGroupId that can be passed to fetch accounts from a specific account group","example":""}],"hasBody":false,"samplePayload":{"referenceId":"REF-1789424098631","status":"PENDING","metadata":{"client":"API_WORKBENCH_SDK"}}},{"id":"POST__accounts_holdings","path":"/accounts/holdings","method":"POST","summary":"Get holdings for a list of accounts.","operationId":"getHoldings","parameters":[{"name":"param","in":"query","required":false,"type":"string","description":"","example":""},{"name":"param","in":"query","required":false,"type":"string","description":"","example":""},{"name":"param","in":"query","required":false,"type":"string","description":"","example":""}],"hasBody":true,"samplePayload":{}},{"id":"POST__accounts_transactions","path":"/accounts/transactions","method":"POST","summary":"Get transactions for a list of accounts.","operationId":"getTransactions","parameters":[{"name":"param","in":"query","required":false,"type":"string","description":"","example":""},{"name":"param","in":"query","required":false,"type":"string","description":"","example":""},{"name":"param","in":"query","required":false,"type":"string","description":"","example":""}],"hasBody":true,"samplePayload":{}},{"id":"POST__accounts_taxlots","path":"/accounts/taxlots","method":"POST","summary":"Get tax lots for a list of accounts.","operationId":"getTaxlots","parameters":[{"name":"param","in":"query","required":false,"type":"string","description":"","example":""},{"name":"param","in":"query","required":false,"type":"string","description":"","example":""},{"name":"param","in":"query","required":false,"type":"string","description":"","example":""}],"hasBody":true,"samplePayload":{}},{"id":"POST__accounts_assets","path":"/accounts/assets","method":"POST","summary":"Get asset details.","operationId":"getAssets","parameters":[{"name":"param","in":"query","required":false,"type":"string","description":"","example":""},{"name":"param","in":"query","required":false,"type":"string","description":"","example":""},{"name":"param","in":"query","required":false,"type":"string","description":"","example":""}],"hasBody":true,"samplePayload":{}},{"id":"POST__accounts_failedtrades","path":"/accounts/failedtrades","method":"POST","summary":"Get Failed Trades.","operationId":"getFailedTrades","parameters":[{"name":"param","in":"query","required":false,"type":"string","description":"","example":""},{"name":"param","in":"query","required":false,"type":"string","description":"","example":""},{"name":"param","in":"query","required":false,"type":"string","description":"","example":""}],"hasBody":true,"samplePayload":{}}]
};

export const SpecUI_Custody: React.FC<SpecUI_CustodyProps> = ({ onExecute }) => {
