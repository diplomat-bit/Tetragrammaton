...
export interface SpecUI_Card_on_File_Data_InquiryProps {
...
const SPEC_META = {
  ...
  version: "1",
  format: "openapi_3",
  description: "Interactive API console and live execution suite for Card on File Data Inquiry.",
  baseUrl: "https://sandbox.api.visa.com",
  endpoints: [{"id":"POST__cofds_web_v1_datainfo","path":"/cofds-web/v1/datainfo","method":"POST","summary":"Card-on-File Merchant Aggregation","operationId":"getMerchantData","parameters":[],"hasBody":true,"samplePayload":{}},{"id":"POST__cofds_web_v1_datainfo_merchants","path":"/cofds-web/v1/datainfo/merchants","method":"POST","summary":"Card-on-File Raw Merchant Details","operationId":"getRawMerchantData","parameters":[{"name":"mrchRef","in":"query","required":true,"type":"string","description":"Correlation ID to uniquely identify the merchant. The reference ID is not static and may change.","example":"MTIzOmV4YW1wbGU"}],"hasBody":true,"samplePayload":{}}]
};

export const SpecUI_Card_on_File_Data_Inquiry: React.FC<SpecUI_Card_on_File_Data_InquiryProps> = ({ onExecute }) => {
