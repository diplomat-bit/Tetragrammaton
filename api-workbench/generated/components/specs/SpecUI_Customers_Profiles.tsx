...
export interface SpecUI_Customers_ProfilesProps {
...
const SPEC_META = {
  ...
  baseUrl: "/api/custmgmt/profiles/v1",
  endpoints: [{"id":"GET__accounts__accountId__details","path":"/accounts/{accountId}/details","method":"GET","summary":"Retrieve restricted customer profile information for specific account","operationId":"get_/accounts/{accountId}/details","parameters":[{"name":"Authorization","in":"header","required":true,"type":"string","description":"The most recent authorization token. This will have the format Bearer + {space} + {accessToken}. Example: Bearer KGNsaWVudF9pZDpjbGllbnRfc2VjcmV0KQ==.","example":""},{"name":"uuid","in":"header","required":true,"type":"string","description":"128 bit random UUID generated uniquely for every request","example":""},{"name":"Accept","in":"header","required":true,"type":"string","description":"Content-Types that are acceptable for the response","example":""},{"name":"client_id","in":"header","required":true,"type":"string","description":"Client ID generated during application registration.","example":""},{"name":"countryCode","in":"header","required":true,"type":"string","description":"Two character ISO format Country Code","example":""},{"name":"accountId","in":"path","required":true,"type":"string","description":"account ID","example":""}],"hasBody":false,"samplePayload":{"referenceId":"REF-1789424098632","status":"PENDING","metadata":{"client":"API_WORKBENCH_SDK"}}}]
};

export const SpecUI_Customers_Profiles: React.FC<SpecUI_Customers_ProfilesProps> = ({ onExecute }) => {
