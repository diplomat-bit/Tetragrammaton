...
export interface SpecUI_Token_AuthorizationProps {
...
const SPEC_META = {
  ...
  version: "1.0.0",
  format: "swagger_2",
  description: "Exchanging the authorization code for an access/refresh token in order to grant a data aggregator permission to access a user’s data and share it with a fintech app. The revoke endpoint allows an aggregator to revoke access for a fintech ap",
  baseUrl: "/api/identity/auth/v1",
  endpoints: [{"id":"POST__oauth2_token_us_gcb","path":"/oauth2/token/us/gcb","method":"POST","summary":"Authorization code grant: Retrieve access token","operationId":"post_/oauth2/token/us/gcb","parameters":[{"name":"Authorization","in":"header","required":true,"type":"string","description":"HTTP Basic authentication by passing base64 encoded value of the client id and client secret separated by colon (:).Example: Base64(client_id:client_secret) will be passed as Basic KGNsaWVudF9pZDpjbGllbnRfc2VjcmV0KQ==","example":""},{"name":"Content-Type","in":"header","required":true,"type":"string","description":"Value should always be application/x-www-form-urlencoded","example":""}],"hasBody":true,"samplePayload":{}},{"id":"POST__oauth2_refresh","path":"/oauth2/refresh","method":"POST","summary":"Authorization code grant: Refresh access token","operationId":"post_/oauth2/refresh","parameters":[{"name":"Authorization","in":"header","required":true,"type":"string","description":"HTTP Basic authentication by passing base64 encoded value of the client id and client secret separated by colon (:).Example: Base64(client_id:client_secret) will be passed as Basic KGNsaWVudF9pZDpjbGllbnRfc2VjcmV0KQ==","example":""},{"name":"Content-Type","in":"header","required":true,"type":"string","description":"Content type. Value is application/x-www-form-urlencoded","example":""}],"hasBody":true,"samplePayload":{}},{"id":"POST__oauth2_revoke","path":"/oauth2/revoke","method":"POST","summary":"Authorization code grant: Revoke access","operationId":"post_/oauth2/revoke","parameters":[{"name":"Authorization","in":"header","required":true,"type":"string","description":"HTTP Basic authentication by passing base64 encoded value of the client id and client secret separated by colon (:).Example: Base64(client_id:client_secret) will be passed as Basic KGNsaWVudF9pZDpjbGllbnRfc2VjcmV0KQ==","example":""},{"name":"Content-Type","in":"header","required":true,"type":"string","description":"Content type. Value is application/x-www-form-urlencoded","example":""}],"hasBody":true,"samplePayload":{}}]
};

export const SpecUI_Token_Authorization: React.FC<SpecUI_Token_AuthorizationProps> = ({ onExecute }) => {
