...
export interface SpecUI_Visa_Accounts_Receivable_ManagerProps {
...
const SPEC_META = {
  ...
  version: "1",
  format: "openapi_3",
  description: "Interactive API console and live execution suite for Visa Accounts Receivable Manager.",
  baseUrl: "https://sandbox.api.visa.com",
  endpoints: [{"id":"POST__varm_v1_suppliermanagement","path":"/varm/v1/suppliermanagement","method":"POST","summary":"Supplier Payment Configuration","operationId":"post_/varm/v1/suppliermanagement","parameters":[],"hasBody":true,"samplePayload":{}},{"id":"POST__varm_v1_participationagreement","path":"/varm/v1/participationagreement","method":"POST","summary":"Supplier Participation Agreement","operationId":"submitParticipationAgreement","parameters":[],"hasBody":true,"samplePayload":{}},{"id":"POST__varm_v1_onboarding_customer","path":"/varm/v1/onboarding/customer","method":"POST","summary":"Supplier Customer Onboarding","operationId":"customerOnboarding","parameters":[],"hasBody":true,"samplePayload":{}},{"id":"POST__varm_v1_merchant_invitation","path":"/varm/v1/merchant/invitation","method":"POST","summary":"Supplier Invitation","operationId":"createMerchantInvitation","parameters":[],"hasBody":true,"samplePayload":{}},{"id":"POST__varm_v1_onboarding_supplier","path":"/varm/v1/onboarding/supplier","method":"POST","summary":"Supplier Profile","operationId":"supplierOnboarding","parameters":[],"hasBody":true,"samplePayload":{}},{"id":"GET__varm_v1_onboardingstatus","path":"/varm/v1/onboardingstatus","method":"GET","summary":"Supplier Onboarding Status","operationId":"getProvisioningStatus","parameters":[{"name":"request_id","in":"query","required":true,"type":"string","description":"Request ID to track the supplier onboarding status","example":""}],"hasBody":false,"samplePayload":{"referenceId":"REF-1789424098647","status":"PENDING","metadata":{"client":"API_WORKBENCH_SDK"}}},{"id":"GET__varm_v1_relationshipinfo","path":"/varm/v1/relationshipinfo","method":"GET","summary":"Supplier Relationship Details","operationId":"getRelationshipInfo","parameters":[{"name":"type","in":"query","required":false,"type":"string","description":"Type of information to retrieve (ALL, SUPPLIER, CUSTOMER)","example":"ALL"},{"name":"supplierId","in":"query","required":false,"type":"string","description":"Primary email address of the supplier to filter by","example":""},{"name":"customerId","in":"query","required":false,"type":"string","description":"Customer ID to filter by","example":""}],"hasBody":false,"samplePayload":{"referenceId":"REF-1789424098647","status":"PENDING","metadata":{"client":"API_WORKBENCH_SDK"}}},{"id":"POST__varm_v1_deposit","path":"/varm/v1/deposit","method":"POST","summary":"Supplier Deposit Confirmation","operationId":"depositConfirmation","parameters":[],"hasBody":true,"samplePayload":{}},{"id":"POST__varm_v1_payment","path":"/varm/v1/payment","method":"POST","summary":"Process Payment Suite Request","operationId":"paymentRequest","parameters":[],"hasBody":true,"samplePayload":{}},{"id":"GET___varm_v1_paymentinfo","path":" /varm/v1/paymentinfo","method":"GET","summary":"Retrieve Payment Status","operationId":"getPaymentInfo","parameters":[{"name":"request_id","in":"query","required":true,"type":"string","description":"Unique identifier for the payment request","example":""},{"name":"payment_id","in":"query","required":false,"type":"string","description":"Specific payment transaction identifier to filter results","example":""},{"name":"pageno","in":"query","required":false,"type":"string","description":"Page number for pagination (default: 1).","example":1}],"hasBody":false,"samplePayload":{"referenceId":"REF-1789424098647","status":"PENDING","metadata":{"client":"API_WORKBENCH_SDK"}}}]
};

export const SpecUI_Visa_Accounts_Receivable_Manager: React.FC<SpecUI_Visa_Accounts_Receivable_ManagerProps> = ({ onExecute }) => {
