...
export interface SpecUI_RewardLinkageShopWithPoints_OpenAPIProps {
...
const SPEC_META = {
  ...
  version: "1.10.0",
  format: "openapi_3",
  description: "This API is used to link credit card to a merchant for rewards redemption.",
  baseUrl: "https://127.0.0.1/openapi/v1/rewards/shopWithPoints",
  endpoints: [{"id":"POST__linkage","path":"/linkage","method":"POST","summary":"Rewards Linkage For Shop with Point","operationId":"ShopWithPointsRewardsLinkage","parameters":[{"name":"param","in":"query","required":false,"type":"string","description":"","example":""},{"name":"param","in":"query","required":false,"type":"string","description":"","example":""},{"name":"param","in":"query","required":false,"type":"string","description":"","example":""},{"name":"param","in":"query","required":false,"type":"string","description":"","example":""},{"name":"param","in":"query","required":false,"type":"string","description":"","example":""},{"name":"param","in":"query","required":false,"type":"string","description":"","example":""},{"name":"param","in":"query","required":false,"type":"string","description":"","example":""}],"hasBody":true,"samplePayload":{}}]
};

export const SpecUI_RewardLinkageShopWithPoints_OpenAPI: React.FC<SpecUI_RewardLinkageShopWithPoints_OpenAPIProps> = ({ onExecute }) => {
