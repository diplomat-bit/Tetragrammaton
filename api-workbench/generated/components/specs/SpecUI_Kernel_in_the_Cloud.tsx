...
export interface SpecUI_Kernel_in_the_CloudProps {
...
const SPEC_META = {
  ...
  version: "1",
  format: "openapi_3",
  description: "Interactive API console and live execution suite for Kernel in the Cloud.",
  baseUrl: "https://sandbox.api.visa.com",
  endpoints: [{"id":"GET__vacservices_v1_list_retrieve__reportGuid___reportId_","path":"/vacservices/v1/list/retrieve/{reportGuid}/{reportId}","method":"GET","summary":"Retrieve List","operationId":"Retrieve List","parameters":[{"name":"reportGuid","in":"path","required":true,"type":"string","description":"","example":"485e0de2-fd7c-8e52-b932-1dc3cb896101"},{"name":"reportId","in":"path","required":true,"type":"integer","description":"","example":""}],"hasBody":false,"samplePayload":{"referenceId":"REF-1789424098634","status":"PENDING","metadata":{"client":"API_WORKBENCH_SDK"}}},{"id":"POST__vacservices_v1_list_device","path":"/vacservices/v1/list/device","method":"POST","summary":"Device List","operationId":"Device List","parameters":[],"hasBody":true,"samplePayload":{}},{"id":"POST__vacservices_v1_list_stores","path":"/vacservices/v1/list/stores","method":"POST","summary":"Store List","operationId":"Store List","parameters":[],"hasBody":true,"samplePayload":{}}]
};

export const SpecUI_Kernel_in_the_Cloud: React.FC<SpecUI_Kernel_in_the_CloudProps> = ({ onExecute }) => {
