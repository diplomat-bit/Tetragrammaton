...
export interface SpecUI_CardAccountBalanceTransferEligibility_OpenAPIProps {
...
const SPEC_META = {
  ...
  version: "1.2.0",
  format: "openapi_3",
  description: "This API is used to check eligibility for balance transfer offer.",
  baseUrl: "https://127.0.0.1/openapi/v1/accounts/loans/balanceTransfers",
  endpoints: [{"id":"GET__","path":"/","method":"GET","summary":"Check Eligibility for Balance Transfer Offer","operationId":"BalanceTransferEligibility","parameters":[{"name":"param","in":"query","required":false,"type":"string","description":"","example":""},{"name":"param","in":"query","required":false,"type":"string","description":"","example":""},{"name":"param","in":"query","required":false,"type":"string","description":"","example":""},{"name":"param","in":"query","required":false,"type":"string","description":"","example":""},{"name":"param","in":"query","required":false,"type":"string","description":"","example":""},{"name":"btSupportedAccountGroup","in":"query","required":false,"type":"string","description":"This field refers the account group supported by Balance Transfer. This is a reference data field. Please use /v1/utilities/referenceData/{btSupportedAccountGroup} resource to get valid value of this field with description.","example":""}],"hasBody":false,"samplePayload":{"referenceId":"REF-1789424098629","status":"PENDING","metadata":{"client":"API_WORKBENCH_SDK"}}}]
};

export const SpecUI_CardAccountBalanceTransferEligibility_OpenAPI: React.FC<SpecUI_CardAccountBalanceTransferEligibility_OpenAPIProps> = ({ onExecute }) => {
