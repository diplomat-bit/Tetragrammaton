...
export interface SpecUI_Visa_DCVV2_GenerateProps {
...
const SPEC_META = {
  ...
  version: "1",
  format: "openapi_3",
  description: "Interactive API console and live execution suite for Visa DCVV2 Generate.",
  baseUrl: "https://sandbox.api.visa.com",
  endpoints: [{"id":"POST__dCVV2_v1_PanDB_Unenroll","path":"/dCVV2/v1/PanDB/Unenroll","method":"POST","summary":"UnEnroll","operationId":"UnEnroll","parameters":[],"hasBody":true,"samplePayload":{"agentId":"sample_string","acctInfo":{"primryAcctNum":{"pan":100}},"cardAcceptr":{"clientId":"sample_string"}}},{"id":"POST__dCVV2_v1_PanDB_Inquiry","path":"/dCVV2/v1/PanDB/Inquiry","method":"POST","summary":"Inquiry","operationId":"Inquiry","parameters":[],"hasBody":true,"samplePayload":{"agentId":"sample_string","acctInfo":{"primryAcctNum":{"pan":100}},"cardAcceptr":{"clientId":"sample_string"}}},{"id":"POST__dCVV2_v1_PanDB_Enroll","path":"/dCVV2/v1/PanDB/Enroll","method":"POST","summary":"Enroll","operationId":"Enroll","parameters":[],"hasBody":true,"samplePayload":{"agentId":"sample_string","acctInfo":{"primryAcctNum":{"pan":100}},"cardAcceptr":{"clientId":"sample_string"}}},{"id":"POST__dCVV2_v1_PanDB_dCVV2GenerationRequest","path":"/dCVV2/v1/PanDB/dCVV2GenerationRequest","method":"POST","summary":"Generate","operationId":"Generate","parameters":[],"hasBody":true,"samplePayload":{"acctInfo":{"primryAcctNum":{"pan":100,"panExpDt":"sample_string"}},"itemCount":1,"cardAcceptr":{"clientId":"sample_string"}}}]
};

export const SpecUI_Visa_DCVV2_Generate: React.FC<SpecUI_Visa_DCVV2_GenerateProps> = ({ onExecute }) => {
