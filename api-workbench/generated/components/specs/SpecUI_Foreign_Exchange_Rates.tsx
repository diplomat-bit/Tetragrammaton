...
export interface SpecUI_Foreign_Exchange_RatesProps {
...
const SPEC_META = {
  ...
  version: "1",
  format: "openapi_3",
  description: "Interactive API console and live execution suite for Foreign Exchange Rates.",
  baseUrl: "https://sandbox.api.visa.com",
  endpoints: [{"id":"POST__forexrates_v2_foreignexchangerates","path":"/forexrates/v2/foreignexchangerates","method":"POST","summary":"Foreign Exchange Rates","operationId":"ForeignExchangeRates","parameters":[],"hasBody":true,"samplePayload":{}},{"id":"POST__forexrates_v1_foreignexchangerates","path":"/forexrates/v1/foreignexchangerates","method":"POST","summary":"Foreign Exchange Rates","operationId":"ForeignExchangeRates","parameters":[],"hasBody":true,"samplePayload":{}}]
};

export const SpecUI_Foreign_Exchange_Rates: React.FC<SpecUI_Foreign_Exchange_RatesProps> = ({ onExecute }) => {
