...
export interface SpecUI_Visa_BIN_Attribute_Sharing_ServiceProps {
...
const SPEC_META = {
  ...
  version: "1",
  format: "openapi_3",
  description: "Interactive API console and live execution suite for Visa BIN Attribute Sharing Service.",
  baseUrl: "https://sandbox.api.visa.com",
  endpoints: [{"id":"POST__filedeliveryservice_v1_binFilesMetadata","path":"/filedeliveryservice/v1/binFilesMetadata","method":"POST","summary":"BIN Files Metadata","operationId":"BinFiles metadata lookup using POST","parameters":[],"hasBody":true,"samplePayload":{}},{"id":"POST__vbass_v1_files_metadata","path":"/vbass/v1/files/metadata","method":"POST","summary":"Files Metadata","operationId":"VBASS Files metadata lookup using POST","parameters":[],"hasBody":true,"samplePayload":{}},{"id":"POST__vbass_v1_files_transfers","path":"/vbass/v1/files/transfers","method":"POST","summary":"File Transfer","operationId":"VBASS File Transfer - POST","parameters":[],"hasBody":true,"samplePayload":{}},{"id":"POST__v1_paymentAccountLookup","path":"/v1/paymentAccountLookup","method":"POST","summary":"PAN TOKEN Lookup Using POST","operationId":"PAN TOKEN Lookup Using POST V1","parameters":[],"hasBody":true,"samplePayload":{}},{"id":"POST__v2_paymentAccountLookup","path":"/v2/paymentAccountLookup","method":"POST","summary":"PAN TOKEN Lookup Using POST V2","operationId":"PAN TOKEN Lookup Using POST V2","parameters":[],"hasBody":true,"samplePayload":{}},{"id":"POST__v2_binRangeDetails","path":"/v2/binRangeDetails","method":"POST","summary":"Bin Range Details Using POST V2","operationId":"Bin Range Details Using POST V2","parameters":[],"hasBody":true,"samplePayload":{}},{"id":"POST__v1_binRangeDetails","path":"/v1/binRangeDetails","method":"POST","summary":"Bin Range Details Using POST","operationId":"Bin Range Details Using POST V1","parameters":[],"hasBody":true,"samplePayload":{}},{"id":"POST__filedeliveryservice_v1_binFileTransfer","path":"/filedeliveryservice/v1/binFileTransfer","method":"POST","summary":"BIN File Transfer","operationId":"Bin File Transfer - POST","parameters":[],"hasBody":true,"samplePayload":{}}]
};

export const SpecUI_Visa_BIN_Attribute_Sharing_Service: React.FC<SpecUI_Visa_BIN_Attribute_Sharing_ServiceProps> = ({ onExecute }) => {
