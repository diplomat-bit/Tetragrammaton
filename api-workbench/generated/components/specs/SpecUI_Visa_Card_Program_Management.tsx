...
export interface SpecUI_Visa_Card_Program_ManagementProps {
...
const SPEC_META = {
  ...
  version: "1",
  format: "openapi_3",
  description: "Interactive API console and live execution suite for Visa Card Program Management.",
  baseUrl: "https://sandbox.api.visa.com",
  endpoints: [{"id":"POST__vcpe_v1_cardAttributes","path":"/vcpe/v1/cardAttributes","method":"POST","summary":"Get Card Attributes","operationId":"post_/vcpe/v1/cardAttributes","parameters":[{"name":"x-api-key","in":"header","required":true,"type":"string","description":"Client-specific API key issued during onboarding.","example":""},{"name":"x-correlation-id","in":"header","required":true,"type":"string","description":"Unique ID for every API request - a mandatory header. Generated by the API client. Used for end-to-end tracing/debugging.","example":""},{"name":"Content-Type","in":"header","required":true,"type":"string","description":"The type of the request body. Not required if the message body is empty in the request, for example, “application/json”","example":"application/json"},{"name":"Accept","in":"header","required":true,"type":"string","description":"Types of content that are acceptable for the request.","example":"application/json"}],"hasBody":true,"samplePayload":{"primaryAccountNumber":4000000000000000}},{"id":"POST__vcpe_v2_pan_enrollment","path":"/vcpe/v2/pan/enrollment","method":"POST","summary":"Enrollment","operationId":"enrollmentV2UsingPOST","parameters":[{"name":"Accept","in":"header","required":true,"type":"string","description":"Accept","example":""},{"name":"Accept-Language","in":"header","required":false,"type":"string","description":"Accept-Language","example":""},{"name":"Content-Type","in":"header","required":true,"type":"string","description":"Content-Type","example":""},{"name":"X-CHANNEL_ID","in":"header","required":true,"type":"string","description":"Default to VTIS","example":""},{"name":"X-CORRELATION-ID","in":"header","required":true,"type":"string","description":"X-CORRELATION-ID","example":""},{"name":"X-API-KEY","in":"header","required":true,"type":"string","description":"X-API-KEY","example":""},{"name":"X-CLIENT-ID","in":"header","required":false,"type":"string","description":"X-CLIENT-ID","example":""},{"name":"Content-Language","in":"header","required":false,"type":"string","description":"Content-Language","example":""}],"hasBody":true,"samplePayload":{"eventName":"ABC","reqRcvdTS":"2020-01-01 10:10:50.234 GMT","operationType":"UPDATE","enrollmentInfo":{"cardholderInfo":{"primaryAccountNumber":"xx"},"accountLevelInfo":{"productID":"G","linkEnrollment":{"group":[{"action":"Add","groupID":"dnVgrLnzKICYNAM6PMBHbw","groupType":"LOC","isPrimaryAccount":""}]},"rpinEnrollment":{"rpin":"111111","action":"Add","accountOpenDate":"20210518","rpinEffectiveDate":"20210518","rpinIssuerRefNumber":"684226"},"replaceEnrollment":{"linkReasonCode":"L","unlinkIndicator":"","oldAccountNumber":"xx"},"benefitsEnrollment":{"addOnBenefits":[{"action":"Add","featureId":{"vfsFeatureId":"vfs01","supplierFeatureId":"supp01","issuerFeatureReferenceId":"reff01"},"enrollmentDate":20240530,"enrollmentStatus":"P","activationEndDate":20240830,"activationStartDate":20240530}],"portfolioBenefits":[{"action":"Add","portfolioId":"dnVgrLnzKICYNAM6PMBHbw","effectiveEndDate":20240830,"effectiveStartDate":20240530}]},"customerContactInfo":{"email":" abc@abcd.com","action":"ADD","address":{"zip":"94404","city":"FC","line1":"123 main st","line2":"apt 1","state":"CA","companyName":"VISA Inc"},"lastName":"hTggkhk","firstName":"Abjhdv","namePrefix":"Mr","nameSuffix":"Sr","mobileNumber":"1111111111","middleInitial":"S","prefMethodOfContact":"M"}}},"updateReferenceID":"wBoC8VdyB921K7xdMroRqw"}}]
};

export const SpecUI_Visa_Card_Program_Management: React.FC<SpecUI_Visa_Card_Program_ManagementProps> = ({ onExecute }) => {
