...
export interface SpecUI_VisaNet_Connect_IssuingProps {
...
const SPEC_META = {
  ...
  version: "1",
  format: "openapi_3",
  description: "Interactive API console and live execution suite for VisaNet Connect - Issuing.",
  baseUrl: "https://sandbox.api.visa.com",
  endpoints: [{"id":"POST__connect_v1_cdb_update","path":"/connect/v1/cdb/update","method":"POST","summary":"CDBUpdate","operationId":"cdbUpdate","parameters":[],"hasBody":true,"samplePayload":{}},{"id":"POST__connect_v1_cardServices_new","path":"/connect/v1/cardServices/new","method":"POST","summary":"New Card","operationId":"visaConnectNewAcct","parameters":[{"name":"X-App-Id","in":"header","required":true,"type":"string","description":"Application identifier that corresponds to the given clientId.","example":""}],"hasBody":true,"samplePayload":{}},{"id":"POST__connect_v1_cardServices_get","path":"/connect/v1/cardServices/get","method":"POST","summary":"Card Inquiry","operationId":"visaConnectAcctInquiry","parameters":[{"name":"X-App-Id","in":"header","required":true,"type":"string","description":"Application identifier that corresponds to the given clientId.","example":""}],"hasBody":true,"samplePayload":{}},{"id":"POST__connect_v1_cardServices_update","path":"/connect/v1/cardServices/update","method":"POST","summary":"Card Update","operationId":"visaConnectUpdateAcct","parameters":[{"name":"X-App-Id","in":"header","required":true,"type":"string","description":"Application identifier that corresponds to the given clientId.","example":""}],"hasBody":true,"samplePayload":{}}]
};

export const SpecUI_VisaNet_Connect_Issuing: React.FC<SpecUI_VisaNet_Connect_IssuingProps> = ({ onExecute }) => {
