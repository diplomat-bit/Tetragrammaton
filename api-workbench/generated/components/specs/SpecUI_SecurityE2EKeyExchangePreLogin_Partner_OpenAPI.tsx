...
export interface SpecUI_SecurityE2EKeyExchangePreLogin_Partner_OpenAPIProps {
...
const SPEC_META = {
  ...
  version: "1.0.0",
  format: "openapi_3",
  description: "This pre-login Proxy is used by browser based applications for retrieving the public key used for encryption.",
  baseUrl: "https://127.0.0.1/openapi/partner/v1/prelogin/security/e2eKey",
  endpoints: [{"id":"GET__","path":"/","method":"GET","summary":"Retrieve Public Key During Pre login for Partner","operationId":"get_/","parameters":[{"name":"param","in":"query","required":false,"type":"string","description":"","example":""},{"name":"param","in":"query","required":false,"type":"string","description":"","example":""},{"name":"param","in":"query","required":false,"type":"string","description":"","example":""},{"name":"param","in":"query","required":false,"type":"string","description":"","example":""},{"name":"param","in":"query","required":false,"type":"string","description":"","example":""}],"hasBody":false,"samplePayload":{"referenceId":"REF-1789424098636","status":"PENDING","metadata":{"client":"API_WORKBENCH_SDK"}}}]
};

export const SpecUI_SecurityE2EKeyExchangePreLogin_Partner_OpenAPI: React.FC<SpecUI_SecurityE2EKeyExchangePreLogin_Partner_OpenAPIProps> = ({ onExecute }) => {
