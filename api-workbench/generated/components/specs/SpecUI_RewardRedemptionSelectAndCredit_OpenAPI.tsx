...
export interface SpecUI_RewardRedemptionSelectAndCredit_OpenAPIProps {
...
const SPEC_META = {
  ...
  version: "1.12.2",
  format: "openapi_3",
  description: "This API is used to redeem the credit card reward points.",
  baseUrl: "https://127.0.0.1/openapi/v1/rewards/selectAndCredit/redemption",
  endpoints: [{"id":"POST__","path":"/","method":"POST","summary":"Redeem Statement Credit","operationId":"SelectAndCreditRedemption","parameters":[{"name":"param","in":"query","required":false,"type":"string","description":"","example":""},{"name":"param","in":"query","required":false,"type":"string","description":"","example":""},{"name":"param","in":"query","required":false,"type":"string","description":"","example":""},{"name":"param","in":"query","required":false,"type":"string","description":"","example":""},{"name":"param","in":"query","required":false,"type":"string","description":"","example":""},{"name":"param","in":"query","required":false,"type":"string","description":"","example":""}],"hasBody":true,"samplePayload":{}}]
};

export const SpecUI_RewardRedemptionSelectAndCredit_OpenAPI: React.FC<SpecUI_RewardRedemptionSelectAndCredit_OpenAPIProps> = ({ onExecute }) => {
