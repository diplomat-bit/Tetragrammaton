...
export interface SpecUI_Accounts_AccountTransactions_FinancialDetails_Digital_Domain_OpenAPIProps {
...
const SPEC_META = {
  ...
  version: "1.3.0",
  format: "openapi_3",
  description: "This MS will provide account summary and transaction list for a member/customer. Change History Date(MM/DD/YYYY) Version SRT Number OPPM ID User Story Description 07-26-2024 1.0.0 SRT 3202 WR202401389 PBWD-12477, PBWD-12478 New MS added 09-",
  baseUrl: "https://127.0.0.1/openapi/accounttransactions/findtls/v1",
  endpoints: [{"id":"GET__accountsummary","path":"/accountsummary","method":"GET","summary":"This API provides the basic details and financial summary of all the accounts belonging to a member/customer","operationId":"RetrieveAccountSummary","parameters":[{"name":"Authorization","in":"header","required":true,"type":"string","description":"The most recent Authorization token. This will have the format Bearer + {space} + {accessToken}. Example: Bearer KGNsaWVudF9pZDpjbGllbnRfc2VjcmV0KQ==.","example":""},{"name":"uuid","in":"header","required":true,"type":"string","description":"128 bit random UUID generated uniquely for every request.","example":""},{"name":"Accept","in":"header","required":true,"type":"string","description":"Content-Type that are acceptable for the response.","example":""},{"name":"client_id","in":"header","required":true,"type":"string","description":"Client ID generated during application registration.","example":""},{"name":"Content-Type","in":"header","required":false,"type":"string","description":"application/json","example":""},{"name":"clientDetails","in":"header","required":false,"type":"string","description":"This field is used to capture device,browser and network information. Refer the developer portal for more information.These are the fields which will be passed as part of the header devicePrint,deviceTokenCookie,userIpAddress,userAgent,hard","example":""}],"hasBody":false,"samplePayload":{"referenceId":"REF-1789424098621","status":"PENDING","metadata":{"client":"API_WORKBENCH_SDK"}}},{"id":"GET__transactiondetails__accountId_","path":"/transactiondetails/{accountId}","method":"GET","summary":"This API gives the list of all the transactions for an account.","operationId":"RetrieveTransactionDetails","parameters":[{"name":"Authorization","in":"header","required":true,"type":"string","description":"The most recent Authorization token. This will have the format Bearer + {space} + {accessToken}. Example: Bearer KGNsaWVudF9pZDpjbGllbnRfc2VjcmV0KQ==.","example":""},{"name":"uuid","in":"header","required":true,"type":"string","description":"128 bit random UUID generated uniquely for every request.","example":""},{"name":"Accept","in":"header","required":true,"type":"string","description":"Content-Type that are acceptable for the response.","example":""},{"name":"client_id","in":"header","required":true,"type":"string","description":"Client ID generated during application registration.","example":""},{"name":"Content-Type","in":"header","required":false,"type":"string","description":"application/json","example":""},{"name":"clientDetails","in":"header","required":false,"type":"string","description":"This field is used to capture device,browser and network information. Refer the developer portal for more information.These are the fields which will be passed as part of the header devicePrint,deviceTokenCookie,userIpAddress,userAgent,hard","example":""},{"name":"accountId","in":"path","required":true,"type":"string","description":"The account identifier in encrypted format. Typically, this is not displayed to the customer","example":"20100002091011"},{"name":"transactionFromDate","in":"query","required":false,"type":"string","description":"Starting range for transaction date in ISO 8601 date format YYYY-MM-DD. The date range can be upto 3 months or 90 days. This date can be 3 years prior to current date.","example":"2022-09-16T00:00:00.000Z"},{"name":"transactionToDate","in":"query","required":false,"type":"string","description":"End range for transaction date in ISO 8601 date format YYYY-MM-DD. The date range can be upto 3 months or 90 days.","example":"2022-10-30T00:00:00.000Z"}],"hasBody":false,"samplePayload":{"referenceId":"REF-1789424098621","status":"PENDING","metadata":{"client":"API_WORKBENCH_SDK"}}}]
};

export const SpecUI_Accounts_AccountTransactions_FinancialDetails_Digital_Domain_OpenAPI: React.FC<SpecUI_Accounts_AccountTransactions_FinancialDetails_Digital_Domain_OpenAPIProps> = ({ onExecute }) => {
