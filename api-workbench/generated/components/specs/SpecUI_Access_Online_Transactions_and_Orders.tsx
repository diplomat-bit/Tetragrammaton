...
export interface SpecUI_Access_Online_Transactions_and_OrdersProps {
...
const SPEC_META = {
  ...
  version: "1.1.1",
  format: "openapi_3",
  description: "This service provides Access Online Transaction and Order details, specifically - Read the details of a transaction - Retrieve the attachments of a transaction - Read the details of an order - Find orders matching search criteria Unless sta",
  baseUrl: "https://apip2.usbank.com/access-online-transactions/v1",
  endpoints: [{"id":"GET__transactions__transactionID_","path":"/transactions/{transactionID}","method":"GET","summary":"Retrieve transaction details.","operationId":"getTransaction","parameters":[{"name":"param","in":"query","required":false,"type":"string","description":"","example":""},{"name":"param","in":"query","required":false,"type":"string","description":"","example":""},{"name":"param","in":"query","required":false,"type":"string","description":"","example":""},{"name":"param","in":"query","required":false,"type":"string","description":"","example":""},{"name":"transactionID","in":"path","required":true,"type":"string","description":"The 29-digit Access Online Transaction Unique Identifier","example":""}],"hasBody":false,"samplePayload":{"referenceId":"REF-1789424098606","status":"PENDING","metadata":{"client":"API_WORKBENCH_SDK"}}},{"id":"GET__transactions__transactionID__attachments","path":"/transactions/{transactionID}/attachments","method":"GET","summary":"Retrieve transaction attachment.","operationId":"getTransactionAttachment","parameters":[{"name":"param","in":"query","required":false,"type":"string","description":"","example":""},{"name":"param","in":"query","required":false,"type":"string","description":"","example":""},{"name":"param","in":"query","required":false,"type":"string","description":"","example":""},{"name":"param","in":"query","required":false,"type":"string","description":"","example":""},{"name":"transactionID","in":"path","required":true,"type":"string","description":"The 29-digit Access Online Transaction Unique Identifier","example":""}],"hasBody":false,"samplePayload":{"referenceId":"REF-1789424098606","status":"PENDING","metadata":{"client":"API_WORKBENCH_SDK"}}},{"id":"GET__orders__orderID_","path":"/orders/{orderID}","method":"GET","summary":"Retrieve order details.","operationId":"getOrder","parameters":[{"name":"param","in":"query","required":false,"type":"string","description":"","example":""},{"name":"param","in":"query","required":false,"type":"string","description":"","example":""},{"name":"param","in":"query","required":false,"type":"string","description":"","example":""},{"name":"param","in":"query","required":false,"type":"string","description":"","example":""},{"name":"orderID","in":"path","required":true,"type":"string","description":"The 8 digit Access Online Order ID","example":""}],"hasBody":false,"samplePayload":{"referenceId":"REF-1789424098606","status":"PENDING","metadata":{"client":"API_WORKBENCH_SDK"}}},{"id":"POST__orders_search","path":"/orders/search","method":"POST","summary":"Find orders matching the search criteria.","operationId":"searchOrders","parameters":[{"name":"param","in":"query","required":false,"type":"string","description":"","example":""},{"name":"param","in":"query","required":false,"type":"string","description":"","example":""},{"name":"param","in":"query","required":false,"type":"string","description":"","example":""},{"name":"param","in":"query","required":false,"type":"string","description":"","example":""},{"name":"param","in":"query","required":false,"type":"string","description":"","example":""}],"hasBody":true,"samplePayload":{}}]
};

export const SpecUI_Access_Online_Transactions_and_Orders: React.FC<SpecUI_Access_Online_Transactions_and_OrdersProps> = ({ onExecute }) => {
