...
export interface SpecUI_Visa_Payment_PasskeyProps {
...
const SPEC_META = {
  ...
  version: "1",
  format: "openapi_3",
  description: "Interactive API console and live execution suite for Visa Payment Passkey.",
  baseUrl: "https://sandbox.api.visa.com",
  endpoints: [{"id":"POST__vpp_v1_passkeys_fido2_attestation","path":"/vpp/v1/passkeys/fido2/attestation","method":"POST","summary":"Register FIDO2 Attestation","operationId":"post_/vpp/v1/passkeys/fido2/attestation","parameters":[],"hasBody":true,"samplePayload":{"referenceId":"REF-1789424098649","status":"PENDING","metadata":{"client":"API_WORKBENCH_SDK"}}},{"id":"POST__vpp_v1_passkeys_oauth2_authorization_request_pushed","path":"/vpp/v1/passkeys/oauth2/authorization/request/pushed","method":"POST","summary":"Create Passkey","operationId":"post_/vpp/v1/passkeys/oauth2/authorization/request/pushed","parameters":[{"name":"param","in":"query","required":false,"type":"string","description":"","example":""},{"name":"param","in":"query","required":false,"type":"string","description":"","example":""},{"name":"param","in":"query","required":false,"type":"string","description":"","example":""},{"name":"param","in":"query","required":false,"type":"string","description":"","example":""}],"hasBody":true,"samplePayload":{}},{"id":"POST__vpp_v1_passkeys_oauth2_token","path":"/vpp/v1/passkeys/oauth2/token","method":"POST","summary":"VPP OAuth Token","operationId":"post_/vpp/v1/passkeys/oauth2/token","parameters":[],"hasBody":true,"samplePayload":{"referenceId":"REF-1789424098649","status":"PENDING","metadata":{"client":"API_WORKBENCH_SDK"}}},{"id":"POST__vpp_v1_passkeys_lcm_subject","path":"/vpp/v1/passkeys/lcm/subject","method":"POST","summary":"Device Registration for Enrollment","operationId":"post_/vpp/v1/passkeys/lcm/subject","parameters":[],"hasBody":true,"samplePayload":{"referenceId":"REF-1789424098649","status":"PENDING","metadata":{"client":"API_WORKBENCH_SDK"}}},{"id":"POST__vpp_v1_passkeys_fido2_assertion","path":"/vpp/v1/passkeys/fido2/assertion","method":"POST","summary":"Verify FIDO2 Assertion","operationId":"post_/vpp/v1/passkeys/fido2/assertion","parameters":[],"hasBody":true,"samplePayload":{"referenceId":"REF-1789424098649","status":"PENDING","metadata":{"client":"API_WORKBENCH_SDK"}}}]
};

export const SpecUI_Visa_Payment_Passkey: React.FC<SpecUI_Visa_Payment_PasskeyProps> = ({ onExecute }) => {
