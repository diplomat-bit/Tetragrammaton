...
export interface SpecUI_Visa_Travel_Notification_ServiceProps {
...
const SPEC_META = {
  ...
  version: "1",
  format: "openapi_3",
  description: "Interactive API console and live execution suite for Visa Travel Notification Service.",
  baseUrl: "https://sandbox.api.visa.com",
  endpoints: [{"id":"POST__travelnotificationservice_v1_travelnotification_itinerary","path":"/travelnotificationservice/v1/travelnotification/itinerary","method":"POST","summary":"Add Travel Itinerary","operationId":"addTravelItineary","parameters":[],"hasBody":true,"samplePayload":{}},{"id":"PUT__travelnotificationservice_v1_travelnotification_itinerary","path":"/travelnotificationservice/v1/travelnotification/itinerary","method":"PUT","summary":"Update Travel Itinerary","operationId":"updateTravelItineary","parameters":[],"hasBody":true,"samplePayload":{}},{"id":"DELETE__travelnotificationservice_v1_travelnotification_itinerary","path":"/travelnotificationservice/v1/travelnotification/itinerary","method":"DELETE","summary":"Delete Travel Itinerary","operationId":"deleteTravelItineary","parameters":[],"hasBody":false,"samplePayload":{}},{"id":"POST__travelnotificationservice_v1_travelnotification_retrievetravel","path":"/travelnotificationservice/v1/travelnotification/retrievetravel","method":"POST","summary":"Retrieve Travel Itinerary","operationId":"Retrieve Travel Itinerary","parameters":[],"hasBody":true,"samplePayload":{"retrieveTravelItinerary":{"toDate":"sample_string","userId":"sample_string","fromDate":"sample_string","partnerBid":"sample_string","travelItineraryId":"sample_string","primaryAccountNumber":{"cardAccountNumber":"sample_string"}}}}]
};

export const SpecUI_Visa_Travel_Notification_Service: React.FC<SpecUI_Visa_Travel_Notification_ServiceProps> = ({ onExecute }) => {
