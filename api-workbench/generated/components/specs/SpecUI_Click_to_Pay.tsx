...
export interface SpecUI_Click_to_PayProps {
...
const SPEC_META = {
  ...
  version: "1",
  format: "openapi_3",
  description: "Interactive API console and live execution suite for Click to Pay.",
  baseUrl: "https://sandbox.api.visa.com",
  endpoints: [{"id":"POST__src_v1_identities_lookup","path":"/src/v1/identities/lookup","method":"POST","summary":"Identity Lookup","operationId":"identityLookup","parameters":[],"hasBody":true,"samplePayload":{"srcClientId":"sample_string","consumerIdentity":{}}},{"id":"POST__src_v1_profiles_prepare","path":"/src/v1/profiles/prepare","method":"POST","summary":"Prepare SRC Profile","operationId":"prepareSrcProfile","parameters":[],"hasBody":true,"samplePayload":{"dpaData":{},"idTokens":[{}],"srcDpaId":"sample_string","srcClientId":"sample_string","srcCorrelationId":"sample_string","srciTransactionId":"sample_string","consumerIdentities":[{}],"dpaTransactionOptions":{}}},{"id":"POST__src_v1_confirmations","path":"/src/v1/confirmations","method":"POST","summary":"Confirmation","operationId":"confirmation","parameters":[],"hasBody":true,"samplePayload":{"srcDpaId":"sample_string","serviceId":{},"customData":{},"srcClientId":"sample_string","srcCorrelationId":"sample_string","confirmationData2":{},"srciTransactionId":"sample_string"}},{"id":"POST__src_v1_cards","path":"/src/v1/cards","method":"POST","summary":"Enroll Card","operationId":"enrollCard","parameters":[],"hasBody":true,"samplePayload":{"srcDpaId":"sample_string","serviceId":{},"srcClientId":"sample_string","encryptedCard":"sample_string","srcCorrelationId":"sample_string","encryptedConsumer":"sample_string","srciTransactionId":"sample_string","complianceSettings":{},"enrollmentReferenceData":{}}},{"id":"POST__src_v1_identities_validation_initiate","path":"/src/v1/identities/validation/initiate","method":"POST","summary":"Initiate Identity Validation","operationId":"initiateIdentityValidation","parameters":[],"hasBody":true,"samplePayload":{"srcClientId":"sample_string","consumerIdentity":{},"idLookupSessionId":"sample_string"}},{"id":"GET__src_v1_transaction_credentials","path":"/src/v1/transaction/credentials","method":"GET","summary":"Get Payload","operationId":"getPayload","parameters":[{"name":"srcClientId","in":"query","required":true,"type":"string","description":"This is the ID shared by the SRC system with the client that identifies the connecting client, such as SRCi, DCF, or SRC Issuer (SRCPI). If an API key was provided, use the API key as the srcClientId.","example":""},{"name":"payloadTypeIndicator","in":"query","required":false,"type":"string","description":"Identifies the type of encrypted payload to be returned. A value of *SUMMARY* is invalid for the GetPayload operation.","example":""},{"name":"srcDpaId","in":"query","required":false,"type":"string","description":"DPA identifier, which is generated by the SRCI during DPA registration.","example":""},{"name":"srcCorrelationId","in":"query","required":false,"type":"string","description":"This is the unique identifier generated by the SRC system to track and link SRC messages. It is used as the transaction identifier assigned by the SRC system for this particular transaction. Must be provided if available from the checkout s","example":""},{"name":"serviceId","in":"query","required":false,"type":"string","description":"(Conditional) Required if using Card on File or Partner Token.","example":""},{"name":"srcDigitalCardId","in":"query","required":false,"type":"string","description":"Reference identifier for the digital card representing the PAN or payment tokens. Conditionality: - Must be provided for card-on-file if the srcCorrelationId is not provided","example":""}],"hasBody":false,"samplePayload":{"referenceId":"REF-1789424098629","status":"PENDING","metadata":{"client":"API_WORKBENCH_SDK"}}},{"id":"POST__src_v1_transaction_credentials","path":"/src/v1/transaction/credentials","method":"POST","summary":"Checkout","operationId":"checkout","parameters":[],"hasBody":true,"samplePayload":{"dpaData":{},"srcDpaId":"sample_string","serviceId":{},"srcClientId":"sample_string","assuranceData":{},"srcCorrelationId":"sample_string","srcDigitalCardId":"sample_string","srciTransactionId":"sample_string","dpaTransactionOptions":{},"encryptedBillingAddress":"sample_string","initializationSessionId":"sample_string","payloadTypeIndicatorPayload":{},"payloadTypeIndicatorCheckout":{}}},{"id":"POST__src_v1_identities_validation_complete","path":"/src/v1/identities/validation/complete","method":"POST","summary":"Complete Identity Validation","operationId":"completeIdentityValidation","parameters":[],"hasBody":true,"samplePayload":{"srcClientId":"sample_string","validationData":"sample_string","idValidationSessionId":"sample_string"}}]
};

export const SpecUI_Click_to_Pay: React.FC<SpecUI_Click_to_PayProps> = ({ onExecute }) => {
