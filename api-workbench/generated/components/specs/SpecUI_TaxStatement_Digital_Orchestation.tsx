...
export interface SpecUI_TaxStatement_Digital_OrchestationProps {
...
const SPEC_META = {
  ...
  version: "1.0.0",
  format: "openapi_3",
  description: "Account Documents APIs Version 2.0. These APIs will be used by Citi Partners to retrieve tax documents for existing Accounts from various regions. PCF Deployment Reference name --> DM-O-DocumentServices-Statements Version 2.0.0 Added new Ta",
  baseUrl: "/gcgapi/docmgmt/taxforms/v1",
  endpoints: [{"id":"GET__taxStatements","path":"/taxStatements","method":"GET","summary":"OB Returns list of masked tax statements","operationId":"getTaxStatements","parameters":[{"name":"Authorization","in":"header","required":true,"type":"string","description":"The authorization token received in earlier API call. This will contain the access token and partner identity. This header is populated only for third-party partners.","example":""},{"name":"Accept","in":"header","required":true,"type":"string","description":"Content types that are acceptable for the response. Currently we support application/json","example":"application/json"},{"name":"uuid","in":"header","required":true,"type":"string","description":"128 bit random UUID generated uniquely for every request","example":"4468adf1-adfe-4f85-a2c1-f29beaa1f6ee"},{"name":"Content-Type","in":"header","required":true,"type":"string","description":"Content-Type of the request","example":""},{"name":"client_id","in":"header","required":true,"type":"string","description":"The client ID received during application registration in the developer portal.","example":"1c5f30d9-043c-49ff-b9c4-255a923278b2"},{"name":"countryCode","in":"header","required":false,"type":"string","description":"Two character ISO format country code.","example":""}],"hasBody":false,"samplePayload":{"referenceId":"REF-1789424098636","status":"PENDING","metadata":{"client":"API_WORKBENCH_SDK"}}},{"id":"GET__taxStatements__taxstatementId_","path":"/taxStatements/{taxstatementId}","method":"GET","summary":"OB Return the masked tax statement for the given tax statement id","operationId":"getTaxStatement","parameters":[{"name":"Authorization","in":"header","required":true,"type":"string","description":"The authorization token received in earlier API call. This will contain the access token and partner identity. This header is populated only for third-party partners.","example":""},{"name":"Accept","in":"header","required":true,"type":"string","description":"Content types that are acceptable for the response. Currently we support application/json","example":"application/json"},{"name":"Content-Type","in":"header","required":true,"type":"string","description":"Content-Type of the request","example":""},{"name":"uuid","in":"header","required":true,"type":"string","description":"128 bit random UUID generated uniquely for every request.","example":"4468adf1-adfe-4f85-a2c1-f29beaa1f6ee"},{"name":"client_id","in":"header","required":true,"type":"string","description":"The client ID received during customer onboarding.","example":"1c5f30d9-043c-49ff-b9c4-255a923278b2"},{"name":"countryCode","in":"header","required":false,"type":"string","description":"Two character ISO format country code.","example":""},{"name":"taxstatementId","in":"path","required":true,"type":"string","description":"Unique id that maps to the specific tax statement to be downloaded.","example":""}],"hasBody":false,"samplePayload":{"referenceId":"REF-1789424098636","status":"PENDING","metadata":{"client":"API_WORKBENCH_SDK"}}}]
};

export const SpecUI_TaxStatement_Digital_Orchestation: React.FC<SpecUI_TaxStatement_Digital_OrchestationProps> = ({ onExecute }) => {
