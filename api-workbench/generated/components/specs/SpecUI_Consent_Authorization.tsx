...
export interface SpecUI_Consent_AuthorizationProps {
...
const SPEC_META = {
  ...
  version: "1.0.0",
  format: "openapi_3",
  description: "Generate an authorization code from a user’s consent by calling the authorize endpoint with the required parameters",
  baseUrl: "/api/identity/v1",
  endpoints: [{"id":"GET__authcode_oauth2_authorize","path":"/authcode/oauth2/authorize","method":"GET","summary":"Authorization code grant: Retrieve authorization code","operationId":"get_/authcode/oauth2/authorize","parameters":[{"name":"scope","in":"query","required":false,"type":"string","description":"The set of scopes required to make the API calls. Scope is case insensitive and multiple values can be passed using space delimiter","example":""},{"name":"response_type","in":"query","required":false,"type":"string","description":"Value MUST be set to \"code\"","example":""},{"name":"redirect_uri","in":"query","required":false,"type":"string","description":"Absolute uri for user-agent redirection.You should provide the uri used during client registration process.","example":""},{"name":"businessCode","in":"query","required":false,"type":"string","description":"The 3 character business code. Use GCB for consumer banking (upper case)","example":""},{"name":"locale","in":"query","required":false,"type":"string","description":"Locale identify a specific language and geographic region, it shoule follow [language[_territory]. eg - en_US, en_SG","example":""},{"name":"state","in":"query","required":false,"type":"string","description":"Opaque value to maintain the state between request and call back. This will be used to prevent cross-site request forgery.","example":""},{"name":"countryCode","in":"query","required":false,"type":"string","description":"Country code in 2 character ISO 3166 format (upper case)","example":""},{"name":"client_id","in":"query","required":false,"type":"string","description":"Absolute uri for user-agent redirection.You should provide the uri used during client registration process.","example":""}],"hasBody":false,"samplePayload":{"referenceId":"REF-1789424098630","status":"PENDING","metadata":{"client":"API_WORKBENCH_SDK"}}}]
};

export const SpecUI_Consent_Authorization: React.FC<SpecUI_Consent_AuthorizationProps> = ({ onExecute }) => {
